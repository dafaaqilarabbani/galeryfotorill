...
@section('isi2')
    ...
    <div class="shadow-lg -gray-300 max-w-[360px] mx-auto mt-[100px] w-full mb-5">
        <form action="/proses_register" method="post">
            @csrf
    <div class="p-4 pb-8 shadow-md bg-gray-300 max-w-[360px] mx-auto mt-[100px] w-full">
        <div class="flex flex-col gap-4">
            <h3 class=" text-3xl text-center font-medium ">REGISTER</h3>
        <div class="mb-2">
            <label for="default-input" class="mb-2 text-sm font-medium dark:text-white">Username</label>
            <input type="text" id="default-input" name="username" class=" border border-black rounded-lg w-full p-2.5 " placeholder="Masukan Username Anda">
            @error('username')
        ...
        <div class="mb-2">
            ...
            <input type="password" id="default-input" name="password" class=" border border-black rounded-lg w-full p-2.5 "  placeholder="********************">
            @error('password')
            <small class="italic text-red-800"> {{ $message }}</small>
            @enderror
        </div> 
        ...
        <div class="text-center">
            <button type="submit" class=" border border-black bg-biru-tua p-2.5 w-full items-center text-white">Register</button>
        </form>
            <div = class="mb-4"></div>
